...
const blogs: Blog[] = [
  {
    ...
    image: "/images/blogpic1.png", // Updated file name
  },
  {
    id: 2,
    title: "Blog Post 2",
    ...
    image: "/images/blogpic2.png", // Updated file name
  },
  {
    id: 3,
    title: "Blog Post 3",
    ...
    image: "/images/blogpic3.png", // Updated file name
  },
];
  ...
  return (
    ...
    <div>
      ...
      <div className="py-16 ml-8 lg:ml-36 space-y-2">
        <h1 className="text-4xl font-bold text-[#001F54]">Blog Page</h1> {/* Dark blue */}
        ...
        <div className="lg:w-1/4 lg:pl-10 mt-10 lg:mt-0">
          ...
          <div className="mb-6">
            ...
            <ul className="space-y-2">
              {[
                { id: 4, image: "/images/blog4.png", title: "Recent Blog 1", date: "December 6, 2024" },
                { id: 5, image: "/images/blog5.png", title: "Recent Blog 2", date: "December 5, 2024" },
                { id: 6, image: "/images/blog6.png", title: "Recent Blog 3", date: "December 4, 2024" },
              ].map((blog) => (
