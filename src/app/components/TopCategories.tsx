...
function TopCategories() {
  const categories = [
    { id: 1, img: "/images/image 20.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 2, img: "/images/chair1.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 3, img: "/images/Trending1.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 4, img: "/images/image 20.png", name: "Mini LCW Chair", price: "$56.00" },
  ];
